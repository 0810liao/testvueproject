<template>
        <tab-bar>
                <tab-bar-item link="/home" >
                    ...
                    <img slot="item-activeicon" src="~assets/img/tabbar/home_active.svg">
                    <div slot="item-text">首页</div>
                </tab-bar-item>
                <tab-bar-item link="/category">
                    <img slot="item-icon" src="~assets/img/tabbar/category.svg">
                    <img slot="item-activeicon" src="~assets/img/tabbar/category_active.svg">
                    <div slot="item-text">分类</div>
                </tab-bar-item>
                <tab-bar-item link="/cart">
                    <img slot="item-icon" src="~assets/img/tabbar/shopcart.svg">
                    <img slot="item-activeicon" src="~assets/img/tabbar/shopcart_active.svg">
                    <div slot="item-text">购物车</div>
                </tab-bar-item>
                <tab-bar-item link="/profile">   
                    <img slot="item-icon" src="~assets/img/tabbar/profile.svg">
                    <img slot="item-activeicon" src="~assets/img/tabbar/profile_active.svg">
